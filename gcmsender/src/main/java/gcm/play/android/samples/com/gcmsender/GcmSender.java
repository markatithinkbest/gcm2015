...
//    public static final String API_KEY = "AIzaSyB3oG47rghHBP-bLB5nHFmJ09UOpu1oTrM";
    public static final String API_KEY = "AIzaSyBXmpmgcBD7JvtWLpigoBhKjhnQJ2Jr2Cw";// Chrome

                                          //AIzaSyB3oG47rghHBP-bLB5nHFmJ09UOpu1oTrM
...
//            jData.put("message", args[0].trim());
            jData.put("message", "在指定位置特定電腦或以授權人員帳號登入");
